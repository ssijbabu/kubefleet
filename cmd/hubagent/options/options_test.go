	...
	testCases := []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--webhook-ca-cert-file=/etc/kubefleet/webhook-ca/ca.crt",
				"--webhook-ca-key-ref=azurekms://vault.vault.azure.net/webhook-ca",
				"--webhook-serving-cert-validity=24h",
			...
			wantWebhookOpts: WebhookAndAdmissionPolicyOptions{
				...
				EnablePDBs:                             true,
				UseCertManager:                         true,
				CACertFile:                             "/etc/kubefleet/webhook-ca/ca.crt",
				CAKeyRef:                               "azurekms://vault.vault.azure.net/webhook-ca",
